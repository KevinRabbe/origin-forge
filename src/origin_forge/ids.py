...
class IdKind(StrEnum):
    ...
    IMPROVEMENT_CANDIDATE = "HIC"
    WORKSHOP_EVALUATION_PLAN = "HPLAN"
    WORKSHOP_EVALUATION_REPORT = "HREP"
    WORKSHOP_EVALUATION_AUDIT = "HAUD"
    WORKSHOP_DECISION = "HDEC"
    CONTEXT_REQUEST = "CTXREQ"
    CONTEXT_OPERATION_CATALOG = "CTXCAT"
    CONTEXT_PROGRAM = "CTXPROG"
    CONTEXT_EXECUTION = "CTXEXEC"
    CONTEXT_PACKAGE = "CTXPKG"
    CONTEXT_EXPERIMENT = "CTXEXP"
    MEDIA_FINGERPRINT = "MFPR"
    ...
    TRAINING_DATASET = "TRDATA"
    TRAINING_ELIGIBILITY_AUDIT = "TRAUD"
    TRAINING_EXPERIMENT_PLAN = "TRPLAN"
    TRAINING_EXPERIMENT_REPORT = "TRREP"
