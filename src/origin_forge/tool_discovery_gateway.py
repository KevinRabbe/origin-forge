...
class ToolDiscoveryGatewayStatus:
    ...
    def to_dict(self) -> dict[str, object]:
        return {
            ...
            "describes_used": self.describes_used,
...
class ToolDiscoveryGateway:
    ...
    def __init__(
        ...
        *,
        ...
        if not isinstance(session, ToolSearchSession):
            raise TypeError("session must be a ToolSearchSession")
        if (
    ...
    def status(self) -> ToolDiscoveryGatewayStatus:
        return ToolDiscoveryGatewayStatus(
            ...
            describes_used=self.session.describes_used,
