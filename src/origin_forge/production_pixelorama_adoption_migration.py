...
PIXELORAMA_PRODUCTION_ADOPTION_MIGRATION = Migration(
    14,
    r"""
CREATE TABLE pixelorama_production_adoptions (
    execution_id TEXT PRIMARY KEY REFERENCES pixelorama_dispatch_output_bindings(execution_id) ON DELETE RESTRICT,
...
CREATE INDEX idx_pixelorama_production_adoptions_status
ON pixelorama_production_adoptions(status, created_at, execution_id);
""",
)
