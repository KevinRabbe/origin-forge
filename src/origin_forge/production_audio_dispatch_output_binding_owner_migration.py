...
AUDIO_DISPATCH_OUTPUT_BINDING_OWNER_MIGRATION = Migration(
    29,
    r"""
DROP INDEX IF EXISTS idx_audio_dispatch_output_bindings_task;

ALTER TABLE audio_dispatch_output_bindings
RENAME TO audio_dispatch_output_bindings_v25;
...
INSERT INTO audio_dispatch_output_bindings SELECT * FROM audio_dispatch_output_bindings_v25;
DROP TABLE audio_dispatch_output_bindings_v25;
