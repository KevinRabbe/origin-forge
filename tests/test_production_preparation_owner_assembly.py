...
''',
    ...
    def test_builtin_owner_is_deterministic_inert_and_preserves_code_owner(self) -> None:
        ...
        self.assertEqual(len(first.descriptors), 4)
        ...
        blender_owner = first.owner("originforge.preparation.blender-export-glb@1")
        self.assertEqual(blender_owner.supported_adapter_id, "originforge.blender.model3d")
        self.assertEqual(blender_owner.supported_dispatch_contract_id, "blender.export-glb@1")
        self.assertEqual(blender_owner.model_strategy_roles, (ModelRole.CODER_STRONG,))
        forbidden = {
            "callable",
            "import_path",
            "endpoint",
        ...
        self.assertTrue(forbidden.isdisjoint(blender_owner.to_dict()))
