...
class AudioProfileTests(unittest.TestCase):
    ...
    def test_piper_profile_requires_model_and_license_identity(self) -> None:
        profile = GovernedAudioProfile.create(
        ...
        self.assertEqual(profile.license_id, "MIT")
        with self.assertRaisesRegex(AudioProfileError, "model and license"):
            GovernedAudioProfile.create(
                kind=AudioProfileKind.PIPER_TTS,
                operation=AudioOperation.SYNTHESIZE_SPEECH,
                backend_id="piper",
