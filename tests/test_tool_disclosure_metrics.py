...
class ToolDisclosureMetricsTests(unittest.TestCase):
    def test_progressive_disclosure_is_measurable_against_full_authorized_catalog(self) -> None:
        ...
        self.assertEqual(footprint.describes_used, 1)
    ...
    def test_small_or_empty_catalog_may_have_negative_savings(self) -> None:
        ...
        self.assertLess(footprint.bytes_avoided, 0)
